...
List<BillingCycle> list = new BillingCycleDao(DBCon.getConnection()).notPaidBills();
%>    
<!DOCTYPE html>
<html>
<head>
...
<div class="container mt-5">
		<div class="card-header my-3 text-center ">All Pending Bill Reports of Users</div>
